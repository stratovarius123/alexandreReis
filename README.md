...
Observação Geral: Lembrando que também possuímos os métodos de editar, listar por id e remover, todos estão mapeados. Caso passe de 30 minutos de utilização do mesmo token, ele irá expirar assim tendo que gerar outro, pois não irar permitir acessar a pagina final.
